...
from ecommerce.extensions.payment.processors.alipay import AliPayProcessor
...
class AliPaymentQueryView(EdxOrderPlacementMixin, APIView):
    ...
    def post(self, request):
        ...
        success = self.payment_processor.alipay_api.verify(data, signature)
        if success and data["trade_status"] in ("TRADE_SUCCESS", "TRADE_FINISHED"):
            resp = data
            transaction_id = resp.get('trade_no')
            trade_state = resp.get('trade_status')
    ...
    def get(self, request):
        ...
        if trade_state == 'TRADE_SUCCESS':
            ...
            _, basket = self._get_basket(out_trade_no, None, False)
