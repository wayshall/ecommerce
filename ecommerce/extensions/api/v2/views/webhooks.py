...
class StripeWebhooksView(APIView):
    ...
    def post(self, request):
        ...
        if event.type == 'payment_intent.succeeded':
            if payment_intent.payment_method_details.type in dynamic_payment_methods_options:
                ...
                webhooks_payment = WebhooksPayment(site=None)
                webhooks_payment.handle_webhooks_payment(payment_intent)
            else:
                logger.info(
